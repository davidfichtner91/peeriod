    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 dark:from-slate-950 dark:to-purple-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-lg shadow-lg p-8">
        <div className="text-center mb-8">
          <Logo variant="gradient" size={96} className="mx-auto mb-4" />
          <h1 className="text-3xl font-bold text-slate-900 dark:text-white tracking-[0.2em] font-medium">PEERIOD</h1>
          <p className="text-slate-600 dark:text-slate-400 text-sm mt-4">Porozumění cyklu, lepší vztah</p>
        </div>
